...
<nav class="bg-gray-800">
      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          <div class="flex-shrink-0 flex items-center">
            ...
            <img class="h-9" src="https://www.pinclipart.com/picdir/big/534-5347028_hd-john-barnes-nike-geometric-cool-nike-logo.png" alt="">
            <a class="text-white no-underline hover:text-white hover:no-underline" href="#">
                <span class="text-2xl pl-2"><i class="em em-grinning"></i> Heroku-Game</span>
              </a>
  ...
  <footer class="bg-blue-300 text-center">Alia Lucas Emanuel</footer>
@endsection
